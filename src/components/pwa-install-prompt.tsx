...
const INSTALL_PROMPT_DELAY_MS = 3_000
...
export function PwaInstallPrompt() {
  ...
  return (
    <aside
      className="fixed inset-x-4 bottom-24 z-60 mx-auto max-w-lg rounded-2xl border border-(--app-border) bg-(--app-surface) p-4 shadow-2xl"
